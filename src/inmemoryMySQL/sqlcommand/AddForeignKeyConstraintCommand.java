...
import inmemoryMySQL.constraint.ParentForeignKeyConstraint;
...
public class AddForeignKeyConstraintCommand implements SQLCommand{
    ...
    public AddForeignKeyConstraintCommand(String parentTable, String childTable, List<ColumnNameMapping> colNameMappings) {
    ...
    public void execute() {
        ...
        child.addConstraint(new ParentForeignKeyConstraint(parent, childColMapping));
